const header = () => {
    ...
    <div class="sidenav-content">
        <p>
                Pine Street, Hawthorn VIC 3123
        </p>
        <p>
            <span class="fs-16 primary-color">(+68) 120034509</span>
        </p>
        <p><a style='font-size:1rem; color:white;' href='mailto:pereragayan99@gmail.com'>pereragayan99@gmail.com</a></p>
    </div>
</div>
...
<nav id="header-navbar" class="navbar navbar-expand-lg py-4">
    <div class="container">
        <div class="navbar-brand d-flex align-items-center text-white" href="/">
...
const footer = () => {
    ...
    <div class="row">
        ...
        <div class="col-lg-4 col-md-12 d-flex align-items-center">
            <p class="mx-auto text-center mb-0">&copy; 28/10/2023 Gayan_webmaster, Rythm Emporium. Design by Gayan Perera.</p>
        </div>
